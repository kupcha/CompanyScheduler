...
public class EmployeeHomeController {
	...
	/*
	 * Will take user to the View Schedule page where they may see their currently
	 * scheduled shifts to work.
	 */
	...
	/*
	 * Will take the user to a page where they can submit their availability to work
	 * for the given week.
	 */
