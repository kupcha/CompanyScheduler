public class User{
	...
	//constructor
	public User(String firstName, String lastName, String username, String password, String email, int phone, String DOB, String address) {
	...
	boolean changePhone(int newPhone) {
		if (newPhone == phone) {
			return false;
		}
		else {
