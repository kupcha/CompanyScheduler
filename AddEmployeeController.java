...
public class AddEmployeeController {
   ...
   */
    ...
    Add an employee into the database, first get all the text then call the db class to connect to the database
    and send in the info
    Clear text and go back one gui
    */
    @FXML
    void AddEmployee(ActionEvent event) {
    	...
    	try {
    	db.add(first_name, last_name, username, password, Dob, email, mobile, address, city, state, zipcode);
    	}
    	catch (Exception e)
        {
